...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://donzdanowicz.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("donzdanowicz@o2.pl");
        driverTrello.findElement(By.id("password")).sendKeys("Zuzalenka2020");
